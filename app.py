...
if go:
    ...
    with st.spinner(text="This might take a while, maybe it's time to grab a coffee ☕"):
        ...
        st.caption("Go ahead and copy the transcript below, or simply download it directly as a text file. No piece of software is perfect and we are continuously improving our algorithms, so you might want to briefly review the transcript after having downloaded it. Thanks for your trust and support!🚀")
